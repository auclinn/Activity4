...
VALUES
	(1, 1, '2023-1-05 00:00:00', 1, 'Healthy check-...', 'N/A', 'Regular check-up, no issues detected'),
	(2, 2, '2023-1-10 00:00:00', 1, 'Vaccination', 'Vaccine X', 'Administered vaccination X as per schedule'),
	(3, 3, '2023-02-02 00:00:00', 3, 'Sprained leg', 'Pain medication', 'Rest reccommended for two weeks'),
